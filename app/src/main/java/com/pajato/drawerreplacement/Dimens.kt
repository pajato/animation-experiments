...
object Dimens {
    ...
    var DURATION_SIZE_START: Float = 16.0f
    var DURATION_SIZE_END: Float = 18.0f
    var DURATION_SIZE_SCALE: Float = 2.0f // DURATION_SIZE_END - DURATION_SIZE_START
    var DURATION_SIZE_SCALE_COMPACT: Float = 3.0f // DURATION_SIZE_SCALE * 1.5f
